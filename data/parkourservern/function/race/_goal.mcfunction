...
execute if score numberOfFinishers raceVariables matches 1 run data merge block -1351 36 -920 {front_text:{messages:[{"text":"Senaste","bold":true},{"selector":"@s","bold":true,"color":"black"},["",{"score":{"name":"@s","objective":"speedrunMinutes"}},{"text":" min"}], ["",{"score":{"name":"@s","objective":"speedrunSeconds"}},{"text":" sek"}]]}}
execute if score numberOfFinishers raceVariables matches 2 run data merge block -1347 36 -920 {front_text:{messages:[{"text":"Senaste","bold":true},{"selector":"@s","bold":true,"color":"black"},["",{"score":{"name":"@s","objective":"speedrunMinutes"}},{"text":" min"}], ["",{"score":{"name":"@s","objective":"speedrunSeconds"}},{"text":" sek"}]]}}
execute if score numberOfFinishers raceVariables matches 3 run data merge block -1355 36 -920 {front_text:{messages:[{"text":"Senaste","bold":true},{"selector":"@s","bold":true,"color":"black"},["",{"score":{"name":"@s","objective":"speedrunMinutes"}},{"text":" min"}], ["",{"score":{"name":"@s","objective":"speedrunSeconds"}},{"text":" sek"}]]}}