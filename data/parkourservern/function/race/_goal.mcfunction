...
execute if score raceGoal raceVariables matches 52 run tellraw @a ["",{"selector":"@s","color":"gold"},{"text":" kom på plats ","color":"yellow"},{"score":{"name":"numberOfFinishers","objective":"raceVariables"},"color":"green"},{"text":" och klarade Gruvbyn på ","color":"yellow"},{"score":{"name":"@s","objective":"speedrunMinutes"},"color":"gold"},{"text":" minuter och ","color":"yellow"},{"score":{"name":"@s","objective":"speedrunSeconds"},"color":"gold"},{"text":" sekunder!","color":"yellow"}]
...
execute if score numberOfFinishers raceVariables matches 1 run tag @s add Vinnare
