...
execute if score preCountdown raceVariables matches 5 run title @a title [{"text":"-Fängelsehålorna-","color":"aqua","bold":true}]
execute unless score preCountdown raceVariables matches 5 run title @a title [{"text":"-Fängelsehålorna-","color":"aqua","bold":true}]
